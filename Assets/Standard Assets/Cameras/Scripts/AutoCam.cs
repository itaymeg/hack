...
namespace UnityStandardAssets.Cameras
{
    ...
    public class AutoCam : PivotBasedCameraRig
    {
        ...
        [SerializeField] private int m_Dis_y = -1;
        [SerializeField] private int m_Dis_z = 5;
        ...
        protected override void FollowTarget(float deltaTime)
        {
            ...
            Vector3 newPos=new Vector3(m_Target.position.x , m_Target.position.y +m_Dis_y, m_Target.position.z + m_Dis_z);
